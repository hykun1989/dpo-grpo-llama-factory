...
class PairwiseDataCollatorWithPadding(MultiModalDataCollatorForSeq2Seq):
    ...
    def __call__(self, features: Sequence[Dict[str, Any]]) -> Dict[str, "torch.Tensor"]:  
        ...
        # Check if features contain ID field  
        # has_ids = "id" in features[0] if features else False  
        # chosen_ids = []  
        # rejected_ids = []  
        ...
        for key in ("chosen", "rejected"):  
            for feature in features:  
                ...
                # if has_ids:  
                #     if key == "chosen":  
                #         chosen_ids.append(feature["id"])  
                #     else:  
                #         rejected_ids.append(feature["id"])  
        ...
        # Get the batch from parent class  
        batch = super().__call__(concatenated_features)  
        
        # Add IDs to batch if they exist  
        # if has_ids:  
        #     batch["id"] = chosen_ids + rejected_ids  
